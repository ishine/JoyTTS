...
def padding(data, use_spk_embedding, mode='train', gan=False):
    ...
    for sample in data:
        ...
        attention_mask = [torch.tensor(sample[i]['attention_mask']) for i in order]
        attention_mask = pad_sequence(attention_mask, batch_first=True, padding_value=0)

        position_ids = [torch.tensor(sample[i]['position_ids']) for i in order]
        ...
        tgt_sizes = [sample[i]['pixel_tgt_sizesvalues'] for i in order]

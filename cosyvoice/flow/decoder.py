...
class CausalAttention(Attention):
    def __init__(
        ...
        if diffusers.__version__ == '0.29.0':
            super(CausalAttention, self).__init__(query_dim, cross_attention_dim, heads, dim_head, dropout, bias, upcast_attention, upcast_softmax,
                                                ...
                                                _from_deprecated_attn_block, processor, out_dim) #diffusers==0.29.0
        else:
            super(CausalAttention, self).__init__(query_dim, cross_attention_dim, heads, None, dim_head, dropout, bias, upcast_attention, upcast_softmax,
                                                cross_attention_norm, cross_attention_norm_num_groups, qk_norm, added_kv_proj_dim, True, norm_num_groups,
                                                spatial_norm_dim, out_bias, scale_qk, only_cross_attention, eps, rescale_output_factor, residual_connection,
                                                _from_deprecated_attn_block, processor, out_dim) #diffusers==0.32.2
